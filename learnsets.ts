export const Learnsets: {[k: string]: ModdedLearnsetData} = {
	...
	// JEP Additions Learnsets
	totartle: {
		learnset: {
			cometpunch: ["1L50, 2L36"],
			earthquake: ["2M"],
			fissure: ["1M"],
			hyperbeam: ["2M"],
			leer: ["1L54"],
			megadrain: ["1M"],
			petaldance: ["1L60, 2L67"],
			roar: ["2M"],
			solarbeam: ["2M"],
		}
	},
	...
	gorochu: {
		learnset: {
			...
			endure: ["2M"],
			flash: ["2M", "1M"],
			focusenergy: ["2L57", "1L57"],
			frustration: ["2M"],
			growl: ["1L1"],
			headbutt: ["2M"],
			hiddenpower: ["2M"],
			horndrill: ["2L65", "1L65", "1M"],
			hyperbeam: ["2M", "1M"],
			irontail: ["2M"],
			leer: ["2L60", "1L60"],
			megakick: ["1M"],
